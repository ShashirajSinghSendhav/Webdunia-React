...
export default class Header extends React.Component {
    constructor(props) {
      ...
      getLanguages(){
        const languageConurl= Globals.language_based_api;
        fetch(languageConurl)
        .then((res) => res.json())
        .then((data) => {
            this.setState({
                languageData :data.Contents[0].Language,
                allLanguageData :data.Contents[0].Languages,
            })
        })
      }
      componentDidMount() {
    ...
    render() {
        ...
        let allLang = this.state.allLanguageData;
        ...
        <h3><a href={item.DefaultUrl}>{item.Text}</a></h3> 
          ...
          <li  id={i}>
            ...
            const LangNames = allLang.map((item , i)  => 
            <li key = {i} ><a className={(langData.Name == item.Name)? 'active' : ''} href='#' title={item.Name} languageCode={item.Code} >{item.Name}</a></li>
            );
                        ...
                        <div className="h_top_block">
                            ...
                            <div className="wd_lang">
                                <ul>
                                    ...
                                    {/* <li><a className="active" href="#">{abc.Name}</a> </li> */}
                                    {LangNames}
